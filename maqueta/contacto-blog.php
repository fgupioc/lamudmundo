<?php include("header.php") ?>
    ...
    <section class="contact-section section">
        <div class="container">
            ...
            <p class="intro text-center">Utilice este canal de comunicación para registrar sus sugerencias o inquietudes. Envíe su mensaje ingresando sus datos.</p>
                    ...
                    <div class="contact-form-inner col-md-8 col-sm-12 col-xs-12 col-md-offset-2 col-sm-offset-0 xs-offset-0">
                        <div class="row">                                                                                       
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                ...
                                <input type="text" class="form-control" id="cname" name="name" placeholder="ingrese su Nombre completo" minlength="2" required>
                            </div>                    
                            <div class="col-md-6 col-sm-6 col-xs-12 form-group">
                                <label class="sr-only" for="cemail">Correo</label>
                                <input type="email" class="form-control" id="cemail" name="email" placeholder="Ingrese su correo" required>
                            </div>
                            <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                <label class="sr-only" for="cmessage">Mensaje</label>
                                <textarea class="form-control" id="cmessage" name="message" placeholder="Escriba su mensaje" rows="12" required></textarea>
                            </div>
                             <div class="col-md-12 col-sm-12 col-xs-12 form-group">

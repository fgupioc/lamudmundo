<?php /* Template Name: turismo_blog */
get_header();
?>
<section class="promo section" style="background-color: #2f4a60">
    <div class="container text-center">
        <h2 class="title">Turismo</h2>
        <p class="intro">Los lugares a donde puedes ir cuando visitas la provincia de Luya</p>
    </div><!--//container-->
</section><!--//promo-->
<!-- ******Work list Section****** -->
<section id="work-list" class="section work-list">
    <div class="container text-center">
        <div id="filters" class="button-group clearfix">
            ...
            <button class="btn button" data-filter=".saas">kuelap</button>
            <button class="btn button" data-filter=".mobile-app">Huaylla Belen</button>
            <button class="btn button" data-filter=".website">Quiocta</button>
            <button class="btn button" data-filter=".startup">Gocta</button>
            <button class="btn button last" data-filter=".agency">Ciudad de los Muertos</button>
            <button class="btn button last" data-filter=".franz">franz</button>
        </div><!--//filters-->
        <div class="items-wrapper isotope row">
            <div class="item startup saas col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-1.jpg"
                                                         alt=""/></a>
            ...
            <div class="item franz saas col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-1.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">franz Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
                        </a><!--//info-mask-->
                    </figure>
                    <div class="content text-left">
            ...
            <div class="item startup mobile-app col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-2.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup website col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-3.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item agency website col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-4.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item agency website col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-5.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup mobile-app col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-6.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup saas col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-7.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup mobile-app website col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-8.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup mobile-app saas col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-9.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup website mobile-app col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-11.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
            ...
            <div class="item startup saas website col-lg-4 col-md-4 col-sm-6 col-sm-12 ">
                <div class="item-inner">
                    <figure class="figure">
                        <a href="case-study-1.html"><img class="img-responsive"
                                                         src="../assets/images/work/work-example-thumb-12.jpg"
                                                         alt=""/></a>
                        <a class="info-mask" href="case-study-1.html">
                            <span class="desc">Project intro goes here lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor...</span>
                            <span class="btn btn-cta btn-cta-primary">View case study</span>
